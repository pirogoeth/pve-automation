...
- 2 cidr ranges for leader and worker nodes NOT handed out by DHCP (nodes are
...
cluster composition in the future. If later on, you want to add another leader
...
- [ ] Add variable to allow workloads on leader nodes
